...
import { IgxNavbarModule, IgxButtonModule, IgxIconModule, IgxCardModule } from 'igniteui-angular';
...
describe('MasterViewComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, IgxNavbarModule, IgxButtonModule, IgxIconModule, IgxCardModule ]
    })
    .compileComponents();
  });
